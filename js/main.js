...
const translations = {
    en: {
        ...
        'hero.desc': 'A powerful code editor with AI Agent for Android and Windows. Built-in Linux environment, LSP support, and Orbit AI assistant.',
    ...
    zh: {
        ...
        'hero.title1': '随时随地编程',
        'hero.title2': '创造无限可能',
        'hero.desc': '强大的代码编辑器，搭载 AI Agent，支持 Android 和 Windows。内置 Linux 环境、LSP 支持和 Orbit AI 助手。',
        'hero.download': '立即下载',
